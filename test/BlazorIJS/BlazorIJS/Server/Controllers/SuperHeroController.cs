...
namespace BlazorIJS.Server.Controllers
{
    ...
    public class SuperHeroController : ControllerBase
    {
        ...
        public static List<DateTimes> dates = new List<DateTimes> {
            new DateTimes { dateTime = DateTime.Now },
            new DateTimes { dateTime = DateTime.UtcNow }
        };
        ...
        // ---------------------------------------------------
        [HttpGet("datetimes")]
        public async Task<ActionResult<List<DateTimes>>> GetDate()
        {
            return Ok(dates);
        }
        // ---------------------------------------------------
